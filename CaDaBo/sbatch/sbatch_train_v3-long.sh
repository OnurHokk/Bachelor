...
declare -a names=(  "random-high-long"      "random-full-long"      "random-full-long-slow" "random-nodisplay-high-long" "random-nodisplay-full-long" "citroen-high-long"     "citroen-augs-high-long" "citroen-nostretch-high-long" "citroen-nostretch-augs-high-long")
declare -a datas=(  "CaDaBo-2-1"            "CaDaBo-2-1"            "CaDaBo-2-1"            "CaDaBo-2-2"                 "CaDaBo-2-2"                 "CaDaBo-2-6"            "CaDaBo-2-9"             "CaDaBo-2-7"                  "CaDaBo-2-8" )
# declare -a imgs=(   960                     960                     960                     960                          960                          960                     960                      960                           960         )
declare -a hyps=(   "hyp.scratch-high.yaml" "hyp.high-fullaug.yaml" "hyp.fullaug-3.yaml"    "hyp.scratch-high.yaml"      "hyp.high-fullaug.yaml"      "hyp.scratch-high.yaml" "hyp.scratch-high.yaml"  "hyp.scratch-high.yaml"       "hyp.scratch-high.yaml")
