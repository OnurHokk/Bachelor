...
declare -a names=(  "citroen-adam-long"     "citroen-full-adam-long"            "citroen-nostretch-adam-long"   "citroen-nostretch-augs-adam-long"  "citroen-nostretch-augs-adam-fulllong"  )
declare -a datas=(  "CaDaBo-2-6"            "CaDaBo-2-6"                        "CaDaBo-2-7"                    "CaDaBo-2-8"                        "CaDaBo-2-8"                            )
# declare -a imgs=(    960                         960                      960                          960                                                          
declare -a hyps=(   "hyp.adam-new-slow.yaml"     "hyp.adam-fullaug-v3.yaml"     "hyp.adam-new-slow.yaml"             "hyp.adam-new-slow.yaml"                 "hyp.adam-fullaug-v3.yaml"    )
